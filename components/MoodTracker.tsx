        ...
        <div className="flex flex-wrap gap-2">
          {PREDEFINED_TRIGGERS.map(t => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${triggers.includes(t)
        ...
        <div className="flex flex-wrap gap-2">
          {PREDEFINED_COPING.map(c => (
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${coping.includes(c)
