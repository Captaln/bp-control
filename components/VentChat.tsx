...
import { Send, Trash2, Sparkles, Flame, Loader2 } from 'lucide-react';
import { Message } from '../types';

export const VentChat: React.FC = () => {
            ...
            <div className="bg-white p-4 shadow-sm z-10 flex flex-col gap-3">
                ...
                <div className="flex bg-slate-100 p-1 rounded-xl">
                    <button
                        ...
                        className={`flex-1 py-2 rounded-lg text-sm font-bold flex items-center justify-center gap-2 transition-all ${mode === 'calm'
                    ...
                    <button
                        ...
                        className={`flex-1 py-2 rounded-lg text-sm font-bold flex items-center justify-center gap-2 transition-all ${mode === 'roast'
                ...
                {messages.map((msg) => {
                    ...
                    return (
                        <div key={msg.id} className={`flex w-full ${isUser ? 'justify-end' : 'justify-start'}`}>
                            <div
                                className={`max-w-[85%] p-3.5 text-sm md:text-base shadow-sm leading-relaxed whitespace-pre-wrap ${isUser
            ...
            <div className="p-3 bg-white border-t border-slate-100 pb-20">
                <div className="flex gap-2 items-end bg-slate-50 border border-slate-200 rounded-2xl p-2 focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary transition-all">
                    ...
                    <button
                        ...
                        className={`p-3 rounded-xl transition-all duration-200 flex-shrink-0 ${input.trim() && !loading
                                ? mode === 'calm'
